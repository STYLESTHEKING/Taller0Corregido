...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Pais al que representa un atleta");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	private void ejecutarbuscarnombre()
	{
		String nombre=input("Por favor ingrese el nombre del atleta que se desea consultar:");
		String namePais= calculadora.PaisAtleta(nombre);
		System.out.println("El pa�s del atleta dado es: "+namePais);
	}
